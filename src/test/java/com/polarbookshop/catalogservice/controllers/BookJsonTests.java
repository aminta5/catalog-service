...
class BookJsonTests {
  ...
  void testSerialize() throws Exception {
    ...
    var now = Instant.now();
    var book = new Book(394L, "1234567890", "Title", "Author", "Polarsophia", 9.90, now, now, 21);
    ...
    assertThat(jsonContent).extractingJsonPathStringValue("@.lastModifiedDate").isEqualTo(book.createdDate().toString());
  ...
  void testDeserialize() throws Exception {
    ...
    assertThat(json.parse(content)).usingRecursiveComparison().isEqualTo(new Book(394L, "1234567890", "Title", "Author", "Polarsophia", 9.90, instant, instant, 21));
  }
}
